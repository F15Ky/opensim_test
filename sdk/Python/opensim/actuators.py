...
class ModOpReplaceMusclesWithPathActuators(ModelOperator):
    ...
    @staticmethod
    def safeDownCast(obj: "OpenSimObject") -> "OpenSim::ModOpReplaceMusclesWithPathActuators *":
    ...
    def clone(self) -> "OpenSim::ModOpReplaceMusclesWithPathActuators *":
...
def ModOpReplaceMusclesWithPathActuators_safeDownCast(obj: "OpenSimObject") -> "OpenSim::ModOpReplaceMusclesWithPathActuators *":
    return _actuators.ModOpReplaceMusclesWithPathActuators_safeDownCast(obj)

def ModOpReplaceMusclesWithPathActuators_getClassName() -> "std::string const &":
    return _actuators.ModOpReplaceMusclesWithPathActuators_getClassName()
